...
public class StaxParserCountries {
	...
	public List<Country> parse(XMLEventReader xmlEventReader)
	...
	private void proceedStartElement(XMLEvent xmlEvent,
		...
		if (xmlEvent.isStartElement()) {
			...
			// set the other varibles from xml elements
				...
				country.setCode(xmlEventReader.nextEvent().asCharacters()
						.getData());
			} else if (isTagNameEqual(startElement, NAME)) {
				country.setName(xmlEventReader.nextEvent().asCharacters()
						.getData());
			} else if (isTagNameEqual(startElement, DESCRIPTION)) {
				country.setDescription(xmlEventReader.nextEvent()
